...
$categories = $wrapper->field_categories->value();
...
if (count($categories)) {
  $categories = implode(', ', array_map('tags_link', $categories));
}
...
<article class="post post--full post--article">
  <?php if ($full_size) { ?>
  ...
  <header class="post-header">
    <div class="post-header__flag">
      ...
      <div class="post-header__body">
        ...
        <p class="post__categories">Posted in <?php echo $categories; ?></p>
